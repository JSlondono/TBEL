                    ...
                    <div id="carouselExample" class="carousel carousel slide" data-bs-interval="false">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <img class="img" src="img/herramientas-2.jpg" alter="Hola">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5>Llaves, tuercas, cerruchos, martillos <b>$25.000</b></h5>
                                    <p>Caja de herramientas para todo tipo de usos</p>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img class="img" src="img/herramientas-3.jpg" alter="Hola">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5>Llaves, tuercas, cerruchos, martillos <b>$35.000</b></h5>
                                    <p>Caja de herramientas para todo tipo de usos.</p>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img class="img" src="img/herramientas-4.jpg" alter="Hola">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5>Llaves, tuercas, cerruchos, martillos <b>$45.000</b></h5>
                                    <p>Caja de herramientas para todo tipo de usos</p>
                                </div>
                            </div>
