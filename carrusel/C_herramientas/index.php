...
<head>
    ...
    <link rel="stylesheet" href="../carruselstyle/estilos.css?v=">
    <script src="/js/mi_script.js?v="></script>
                    ...
                    <div id="carouselExample" class="carousel carousel slide" data-bs-interval="false">
                        ...
                        <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <!--PRODUCTO IMAGEN-->
                                    <img src="../../recursos/img/bombilla.jpg/">
                                    <div class="carousel-caption d-none d-md-block">
                                        <h5>Bombillas led
                                            <b>$8000</b>
                                        </h5>
                                        <p>Bombillas ahorradoras LED</p>
                                    </div>
                                </div>

                                <div class="carousel-item">
                                        <img src="../../recursos/img/destornillador/">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Destornillador
                                                <b>$3000</b>
                                            </h5>
                                            <p>Destornillador de pala grande</p>
                                        </div>
                                </div>

                                <div class="carousel-item">
                                        <img src="../../recursos/img/pegante/">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Pegante
                                                <b>$10.000</b>
                                            </h5>
                                            <p>Lleva pegante para todo tipo de madera</p>
                                        </div>
                                </div>
                        </div>
