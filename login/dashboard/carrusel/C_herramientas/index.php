...
<body>
    ...
    // consultar
    $query = "SELECT * FROM productos WHERE categorias = 'Herramientas' and id = 1 and VendedorId = 1";
    $query2 = "SELECT * FROM productos WHERE categorias = 'Herramientas' and id = 2 and VendedorId = 1";
    $query3 = "SELECT * FROM productos WHERE categorias = 'Herramientas' and id = 3 and VendedorId = 1";
