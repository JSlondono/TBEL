				...
				<div class="row justify-content-between align-items-center">
					...
					<div class="app-utilities col-auto">
							...
							<div class="dropdown-menu p-0" aria-labelledby="notifications-dropdown-toggle">
								...
								<div class="dropdown-menu-content">
									<div class="item p-3">
										...
										<!--//row-->
										<a class="link-mask" href="notificaciones.php"></a>
									</div>
									<!--//item-->
									<div class="item p-3">
										<div class="row gx-2 justify-content-between align-items-center">
									...
									<div class="item p-3">
										<div class="row gx-2 justify-content-between align-items-center">
											...
											<div class="col">
												<div class="info">
													<div class="desc">Tus ventas aumentaron en un 25% en los ultimos 15 días</div>
													<div class="meta">Hace 3 días</div>
												</div>
											</div>
											<!--//col-->
										</div>
									...
									<div class="item p-3">
										<div class="row gx-2 justify-content-between align-items-center">
											...
											<div class="col">
												<div class="info">
													<div class="desc">Fernando Suarez te ha enviado un mensaje</div>
													<div class="meta"> Hace 7 días</div>
												</div>
											</div>
											<!--//col-->
										</div>
								...
								<div class="dropdown-menu-footer p-2 text-center">
									<a href="notificaciones.php">Ver todos</a>
								</div>
						...
						<div class="app-utility-item">
							<a href="configuraciones.php" title="Settings">
					...
					<li class="nav-item has-submenu">
						...
						<div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
							<ul class="submenu-list list-unstyled">
								...
								<li class="submenu-item"><a class="submenu-link" href="crud/admin/productos/crear.php">Nuevo producto</a></li>
